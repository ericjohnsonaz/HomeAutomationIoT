...
static const String SENSOR_NAME = "Kitchen";
//url += "Family_Room";
//url += "Downstairs_Hall";
//url += "Upstairs_Hall";
//url += "Outside";
...
static const String LOCATION = "Home_Kitchen";
...
static const String SOFTWARE_VERSION = "1.0.7";
...
static const uint8_t D3   = 0; //Onboard and External Red LED
static const uint8_t D4   = 2; //Onboard Blue LED
static const uint8_t D5   = 14;
static const uint8_t D6   = 12;
static const uint8_t D7   = 13;//External Green LED
...
void sendTeperature(float temp)
{
  ...
  while (!client.connect(EIOT_IP_ADDRESS, EIOT_PORT)) {
    ...
    attempts ++;
    if (attempts >= 50) {
      writeStatusLedError("Unable to connect to AP after 50 attempts", 300, 250, "sendTemperature");
      attempts = 0;
      return;
    }
  }
