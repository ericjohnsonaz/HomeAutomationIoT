...
static const String SENSOR_NAME = "Family_Room";
  //url += "Family_Room";
  //url += "Downstairs_Hall";
  
static const String LOCATION = "Home_Family_Room";
  //url += "Home_Family_Room";
  //url += "Home_Downstairs_Hall";

static const String SOFTWARE_VERSION = "1.0.4";
...
void setup() {
  ...
  Serial.println("");
  Serial.print("turning on external LED....");
  pinMode(D7, OUTPUT);
  digitalWrite(D7, LOW);
  Serial.println();
...
//      WL_DISCONNECTED = 6
      ...
      error += WiFi.status();
      writeStatusLedError(error, 4, 100, "wifiConnect()");
      //Serial.print(".");
      attempts ++;
      if (attempts >= 100){
